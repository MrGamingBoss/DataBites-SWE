...
INSERT INTO food_logs (user_id, food_name, logged_at, meal_type, mood, notes) VALUES
    ...
    (1, 'Grilled chicken wrap',      '2026-03-09 12:30:00', 'lunch',     'satisfied',  'dining hall'),
    ...
    (1, 'Scrambled eggs and toast',  '2026-03-08 09:00:00', 'breakfast', 'satisfied',  NULL),
    ...
    (1, 'Turkey sandwich',           '2026-03-07 12:00:00', 'lunch',     'satisfied',  'from the cafe'),
    (1, 'Apple and peanut butter',   '2026-03-07 16:00:00', 'snack',     'happy',      NULL),
    (1, 'Stir fry with rice',        '2026-03-07 19:30:00', 'dinner',    'energized',  'tried a new recipe'),
    ...
    (1, 'Chips and salsa',           '2026-03-06 17:00:00', 'snack',     'satisfied',  NULL),
    (1, 'Burrito bowl',              '2026-03-06 20:00:00', 'dinner',    'happy',      'chipotle run'),
    (1, 'Avocado toast',             '2026-03-05 09:00:00', 'breakfast', 'energized',  'treated myself'),
    (1, 'Soup and bread',            '2026-03-05 12:30:00', 'lunch',     'sad',        'not feeling great'),
    (1, 'Granola bar',               '2026-03-05 15:30:00', 'snack',     'tired',      NULL),
    (1, 'Spaghetti bolognese',       '2026-03-05 19:00:00', 'dinner',    'satisfied',  'mom''s recipe'),
    (1, 'Pancakes',                  '2026-03-04 10:00:00', 'breakfast', 'happy',      'weekend treat'),
    (1, 'Grilled cheese',            '2026-03-04 14:00:00', 'lunch',     'happy',      NULL),
    (1, 'Ice cream',                 '2026-03-04 20:00:00', 'snack',     'indulgent',  'movie night'),
    (1, 'Chicken and veggies',       '2026-03-04 19:00:00', 'dinner',    'satisfied',  'meal prepped'),
    (1, 'Bagel with cream cheese',   '2026-03-03 08:30:00', 'breakfast', 'satisfied',  NULL),
    (1, 'Cobb salad',                '2026-03-03 12:00:00', 'lunch',     'happy',      NULL),
    (1, 'Protein bar',               '2026-03-03 15:00:00', 'snack',     'energized',  'post gym'),
    (1, 'Tacos',                     '2026-03-03 19:30:00', 'dinner',    'adventurous','taco tuesday'),
    (1, 'French toast',              '2026-03-02 09:00:00', 'breakfast', 'happy',      'slow morning'),
    (1, 'Tomato soup',               '2026-03-02 13:00:00', 'lunch',     'sad',        'rainy day'),
    (1, 'Orange slices',             '2026-03-02 16:00:00', 'snack',     'satisfied',  NULL),
    (1, 'Grilled salmon',            '2026-03-02 19:00:00', 'dinner',    'happy',      'treat yourself'),
    (1, 'Smoothie',                  '2026-02-28 08:00:00', 'breakfast', 'energized',  'berry blend'),
    (1, 'Veggie wrap',               '2026-02-28 12:30:00', 'lunch',     'satisfied',  NULL),
    ...
    (1, 'BLT sandwich',              '2026-02-27 12:00:00', 'lunch',     'satisfied',  NULL),
    (1, 'Banana',                    '2026-02-27 15:00:00', 'snack',     'tired',      NULL),
    (1, 'Mac and cheese',            '2026-02-27 19:30:00', 'dinner',    'comforted',  'comfort food'),
    (1, 'Waffles with syrup',        '2026-02-26 09:30:00', 'breakfast', 'energized',  'weekend'),
    (1, 'Chicken noodle soup',       '2026-02-26 13:00:00', 'lunch',     'sad',        'feeling under the weather'),
    (1, 'Trail mix',                 '2026-02-26 16:00:00', 'snack',     'satisfied',  NULL),
    (1, 'Veggie pizza',              '2026-02-26 19:30:00', 'dinner',    'happy',      'pizza friday'),
    (1, 'Greek yogurt',              '2026-02-25 08:00:00', 'breakfast', 'satisfied',  NULL);
...
INSERT INTO food_logs (user_id, food_name, logged_at, meal_type, mood, notes) VALUES
    (2, 'Protein shake',             '2026-03-09 07:30:00', 'breakfast', 'energized',  'post workout'),
    (2, 'Chicken rice bowl',         '2026-03-09 12:00:00', 'lunch',     'happy',      'meal prepped'),
    (2, 'Mixed nuts',                '2026-03-09 15:30:00', 'snack',     'satisfied',  NULL),
    (2, 'Beef tacos',                '2026-03-09 19:00:00', 'dinner',    'happy',      'homemade'),
    (2, 'Bagel with cream cheese',   '2026-03-08 08:30:00', 'breakfast', 'satisfied',  NULL),
    (2, 'Burger and fries',          '2026-03-08 13:30:00', 'lunch',     'happy',      'out with friends'),
    (2, 'Grapes',                    '2026-03-08 16:00:00', 'snack',     'satisfied',  NULL),
    ...
    (2, 'Club sandwich',             '2026-03-07 13:00:00', 'lunch',     'satisfied',  NULL),
    (2, 'Protein bar',               '2026-03-07 16:00:00', 'snack',     'energized',  'pre workout'),
    (2, 'Steak and potatoes',        '2026-03-07 19:00:00', 'dinner',    'indulgent',  'treated myself'),
    (2, 'Oatmeal',                   '2026-03-06 08:00:00', 'breakfast', 'satisfied',  NULL),
    (2, 'Tuna salad sandwich',       '2026-03-06 12:30:00', 'lunch',     'satisfied',  NULL),
    ...
    (2, 'Veggie burger',             '2026-03-05 12:00:00', 'lunch',     'adventurous','trying something new'),
    (2, 'Crackers',                  '2026-03-05 15:00:00', 'snack',     'tired',      NULL),
    (2, 'Sushi',                     '2026-03-05 19:30:00', 'dinner',    'adventurous','sushi night'),
    ...
    (2, 'Grilled chicken and rice',  '2026-03-04 19:00:00', 'dinner',    'satisfied',  'meal prep'),
    (2, 'Toast with jam',            '2026-03-03 08:00:00', 'breakfast', 'satisfied',  NULL),
    (2, 'Caesar salad',              '2026-03-03 12:30:00', 'lunch',     'happy',      NULL),
    (2, 'Banana',                    '2026-03-03 15:00:00', 'snack',     'satisfied',  NULL),
    (2, 'Shrimp stir fry',           '2026-03-03 19:00:00', 'dinner',    'adventurous','new recipe'),
    (2, 'Avocado toast',             '2026-03-02 09:00:00', 'breakfast', 'happy',      NULL),
    (2, 'Soup and sandwich',         '2026-03-02 13:00:00', 'lunch',     'satisfied',  NULL),
    (2, 'Cheese and crackers',       '2026-03-02 16:00:00', 'snack',     'happy',      NULL),
    (2, 'Baked salmon',              '2026-03-02 19:30:00', 'dinner',    'happy',      'healthy dinner'),
    (2, 'Pancakes',                  '2026-03-01 10:00:00', 'breakfast', 'energized',  'sunday brunch'),
    (2, 'Chicken sandwich',          '2026-03-01 14:00:00', 'lunch',     'satisfied',  NULL),
...
INSERT INTO food_logs (user_id, food_name, logged_at, meal_type, mood, notes) VALUES
    (3, 'Green smoothie',            '2026-03-09 07:45:00', 'breakfast', 'energized',  'kale and mango'),
    (3, 'Quinoa salad',              '2026-03-09 12:00:00', 'lunch',     'happy',      'meal prepped'),
    (3, 'Rice cakes',                '2026-03-09 15:00:00', 'snack',     'satisfied',  NULL),
    ...
    (3, 'Caprese sandwich',          '2026-03-08 12:30:00', 'lunch',     'satisfied',  NULL),
    (3, 'Edamame',                   '2026-03-08 15:30:00', 'snack',     'happy',      NULL),
    (3, 'Veggie pasta',              '2026-03-08 19:00:00', 'dinner',    'satisfied',  NULL),
    (3, 'Acai bowl',                 '2026-03-07 09:00:00', 'breakfast', 'energized',  'weekend treat'),
    (3, 'Falafel wrap',              '2026-03-07 13:00:00', 'lunch',     'happy',      'from the food truck'),
    (3, 'Fruit salad',               '2026-03-07 16:00:00', 'snack',     'happy',      NULL),
    (3, 'Mushroom risotto',          '2026-03-07 19:30:00', 'dinner',    'adventurous','date night in'),
    (3, 'Oat bran',                  '2026-03-06 08:00:00', 'breakfast', 'satisfied',  NULL),
    (3, 'Greek salad',               '2026-03-06 12:00:00', 'lunch',     'happy',      NULL),
    (3, 'Almonds and dried fruit',   '2026-03-06 15:00:00', 'snack',     'satisfied',  NULL),
    ...
    (3, 'Hummus and veggie wrap',    '2026-03-05 12:30:00', 'lunch',     'satisfied',  NULL),
    (3, 'Apple slices',              '2026-03-05 15:30:00', 'snack',     'happy',      NULL),
    (3, 'Black bean tacos',          '2026-03-05 19:00:00', 'dinner',    'energized',  'taco tuesday'),
    (3, 'Muesli with almond milk',   '2026-03-04 09:00:00', 'breakfast', 'happy',      'weekend morning'),
    (3, 'Avocado and egg toast',     '2026-03-04 13:00:00', 'lunch',     'energized',  'brunch vibes'),
    (3, 'Dark chocolate',            '2026-03-04 16:00:00', 'snack',     'indulgent',  'small treat'),
    (3, 'Stuffed bell peppers',      '2026-03-04 19:30:00', 'dinner',    'happy',      'new recipe'),
    (3, 'Overnight oats',            '2026-03-03 08:00:00', 'breakfast', 'satisfied',  'easy morning');
...
INSERT INTO food_log_audit (log_id, user_id, action, food_name, logged_at, meal_type, mood, notes) VALUES
    ...
    (6,   1, 'create', 'Caesar salad',        '2026-03-08 13:00:00', 'lunch',     'satisfied', NULL),
